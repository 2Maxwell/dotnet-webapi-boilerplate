...
public class BookingPolicy : AuditableEntity<int>, IAggregateRoot
{
    ...
    public BookingPolicy(int mandantId, string? name, string? kz, string? description, string? displayShort, string? display, string? confirmationText, bool isDefault, bool creditCard, bool deposit, int priority)
    {
        MandantId = mandantId;
        Name = name;
        Kz = kz;
    ...
    public BookingPolicy Update(string? name, string? kz, string? description, string? displayShort, string? display, string? confirmationText, bool isDefault, bool creditCard, bool deposit, int priority)
    {
