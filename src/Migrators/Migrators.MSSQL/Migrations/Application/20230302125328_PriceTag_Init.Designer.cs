...
namespace Migrators.MSSQL.Migrations.Application
{
    ...
    [Migration("20230302125328_PriceTag_Init")]
    partial class PriceTag_Init
    {
            ...
            modelBuilder.Entity("FSH.WebApi.Domain.Hotel.PriceTagDetail", b =>
                {
                    b.HasOne("FSH.WebApi.Domain.Hotel.PriceTag", null)
                        .WithOne("PriceTagDetails")
                        .HasForeignKey("FSH.WebApi.Domain.Hotel.PriceTagDetail", "PriceTagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
